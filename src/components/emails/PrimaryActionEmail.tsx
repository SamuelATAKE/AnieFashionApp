...
export const EmailTemplate = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Le marché de la mode de haute qualité.
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            Bienvenue sur AnieFashion, le marché des produits de mode de haute qualité. Utilisez le bouton ci-dessous pour {actionLabel}.
          </Text>
