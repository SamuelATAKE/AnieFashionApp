...
const perks = [
  {
    ...
    description:
      'Recevez votre reçu par courrier électronique en quelques secondes et la livraison ensuite.',
  },
  {
      ...
      <MaxWidthWrapper>
        <div className='py-20 mx-auto text-center flex flex-col items-center max-w-3xl'>
          ...
          <p className='mt-6 text-lg max-w-prose text-muted-foreground'>
            Bienvenue à AnieFashion. Chaque actif de notre plateforme est vérifié par notre équipe pour garantir nos normes de qualité les plus élevées.
          </p>
